...
public class WiseSayingController {
    ...
    private void read() throws IOException {
        List<WiseSaying> wiseSayingList = wiseSayingRepository.readAll();
    ...
    private void update(String command) throws IOException {
        ...
        WiseSaying oldWiseSaying = wiseSayingRepository.read(updateId);
        ...
        wiseSayingRepository.update(updateId, newContent, newAuthor);
    }

    private void post() throws IOException {
        int wiseSayingId = wiseSayingRepository.create(inputView.readContent(), inputView.readAuthor());
